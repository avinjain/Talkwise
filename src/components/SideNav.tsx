  ...
  return (
    <nav className="flex-1 space-y-5 overflow-y-auto p-3">
      <div className="space-y-0.5">
        <NavLink label="Home" active={isHome} onClick={() => go('/home')} icon={HomeIcon} />
      </div>

      <SectionGroup label="Interview prep">
        <NavLink label="Prepare for interview" active={isPrepare} onClick={() => go('/prepare')} icon={InterviewIcon} />
        <NavLink label="Story bank" active={isStorybank} onClick={() => go('/prepare/storybank')} icon={BookIcon} />
        <NavLink label="Build my resume" active={isResume} onClick={() => go('/resume')} icon={ResumeIcon} />
      </SectionGroup>

      <SectionGroup label="Practice">
        <NavLink label="Practice conversations" active={isPractice} onClick={() => go('/configure')} icon={ChatBubbleIcon} />
        <NavLink label="Conversation" active={isConversation} onClick={() => go('/chat')} icon={ConversationIcon} />
      </SectionGroup>

      <SectionGroup label="Profile">
        <NavLink label="Know yourself" active={isProfile} onClick={() => go('/profile')} icon={SparkleIcon} />
      </SectionGroup>
