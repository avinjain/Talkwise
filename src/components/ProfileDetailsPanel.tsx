...
/** Profile page: Side nav (Personality tests | Prepare me for new job), main area switches by tab */
  ...
  const resumeInputSection = (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
      <div className="flex items-center gap-2 mb-5">
        ...
        <h2 className="text-base font-semibold text-slate-900">Prepare me for new job</h2>
      </div>
      <p className="text-sm text-slate-500 mb-5">
        Share your resume and LinkedIn so we can align your profile, sharpen your materials, and get you interview-ready.
      </p>
      ...
      <main className="flex-1 min-w-0">
        ...
        {activeTab === 'resume' && (
          <div className="space-y-6">
            {/* Top: resume & LinkedIn inputs for new-job prep */}
            {resumeInputSection}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div className="px-4 py-3 border-b border-slate-100 bg-slate-50/50">
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">Profile alignment, keywords, and action items</p>
                </div>
                <div className="p-4">
                  {hasInput ? (
                ...
                <div className="p-4">
                  {hasResume ? (
                    <div className="space-y-3">
                      ...
                      {resumeOptimisation ? (
                        <div className="max-h-[50vh] overflow-y-auto p-4 rounded-lg bg-slate-50 border border-slate-100">
                          <AnalysisDisplay content={resumeOptimisation} />
                        </div>
                      ) : (
                        <p className="text-sm text-slate-400 text-center py-3">
                    ...
                    <p className="text-sm text-slate-400 text-center py-4">
                      Add your resume above to optimise it.
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div className="p-4">
                  {hasResume ? (
                    <div className="space-y-3">
                      ...
                      {pitches.length > 0 ? (
                        <div className="space-y-3 overflow-y-auto max-h-[50vh]">
                          {pitches.map((p, i) => (
                            <div key={i} className="rounded-lg p-4 bg-slate-50 border border-slate-100">
                              <h4 className="text-sm font-semibold text-slate-800 mb-1">{p.name}</h4>
                              {p.hook && (
                    ...
                    <p className="text-sm text-slate-400 text-center py-4">
                      Add your resume above to generate speaking points.
                    </p>
                  )}
                </div>
              </div>
